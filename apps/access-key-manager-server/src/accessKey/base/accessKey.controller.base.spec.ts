  ...
  test("POST /accessKeys", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateOfProcurement: CREATE_RESULT.dateOfProcurement.toISOString(),
      ...
      .expect([
        {
          ...
          dateOfProcurement:
            FIND_MANY_RESULT[0].dateOfProcurement.toISOString(),
  ...
  test("GET /accessKeys/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateOfProcurement: FIND_ONE_RESULT.dateOfProcurement.toISOString(),
